...
namespace Norma\Service\Image\Driver;
 ...
 * 基于GD库的Image服务驱动
 *
 * $img = Norma\Service\Image::factory('GDImage',array('5.png','1.bmp','3.jpc','4.jpg','2.gif','6.swf','7.wbmp'));
 * $img->thumb(260,100)->ttftext('测试',40,40,18,'./fs.ttf',0,255,0)->save();
 *
 * $img = Norma\Service\Image::factory('GDImage');
