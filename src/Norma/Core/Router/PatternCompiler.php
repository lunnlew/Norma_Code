...
class PatternCompiler
{
     ...
     * @param array  $options
     */
    public static function compilePattern($pattern, $options = array())
    {
        $len = strlen($pattern);
        /**
         * contains:
     ...
     */
    public static function splitTokens($string)
    {
     ...
     */
    public static function compile($pattern, $options = array())
    {
