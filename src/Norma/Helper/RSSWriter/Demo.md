...
$feed = new \Norma\Helper\RSSWriter\Feed('<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom"/>');

$channel = new \Norma\Helper\RSSWriter\Channel();
$channel
	...
	->appendTo($feed);
// RSS image
$image = new \Norma\Helper\RSSWriter\Image();
$image
...
// RSS item
// $item->clearAttr();
$item = new \Norma\Helper\RSSWriter\Item();
$item
	->atomlink(array('href' => 'http://dallas.example.com/rss.xml', 'rel' => 'slef', 'type' => 'application/rss+xml'))
