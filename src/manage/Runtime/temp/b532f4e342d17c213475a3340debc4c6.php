<?php if (!defined('IS_SECURITY')) exit(); /*a:3:{s:59:"E:\Workspace\Norma_Code\src\manage/app\view\home\index.html";i:1474255311;s:62:"E:\Workspace\Norma_Code\src\manage/app\view\Public\header.html";i:1474181261;s:63:"E:\Workspace\Norma_Code\src\manage/app\view\Public\sidebar.html";i:1474188503;}*/ ?>
<!doctype html>
    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
        <ul class="am-list admin-sidebar-list">
            ...
            <li class="admin-parent">
                ...
                <ul class="am-list am-collapse admin-sidebar-sub" id="model-collapse-nav">
                    <li><a href="<?php echo Url('app/options/list',array('appid'=>10000)); ?>" class="am-cf"><span class="am-icon-check"></span> 配置设置<span class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
                </ul>
            </li>
        </ul>
    </div>
        ...
        <div class="admin-content">
            <div class="admin-content-body">
                ...
                <li><a href="<?php echo Url('app/home/detail',array('appid'=>10000)); ?>" class="am-text-success"><span class="am-icon-btn am-icon-file-text"></span><br/>Manage应用</a></li>
                </ul>
            </div>
...
//editables 
$('.ratio').editable({
    url: "<?php echo Url('/Api/Ratio/update'); ?>",
    type: 'number',
    pk: 1
});
//editables 
$('.sys').editable({
    url: "<?php echo Url('/Api/Sys/update'); ?>",
    type: 'text',
    pk: 1
});
</script>
