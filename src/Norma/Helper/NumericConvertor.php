...
class NumericConvertor
{
     ...
     * @var string
     */
    public $split_pattern = '//u';
    /**
     * 中文数字处理正则
     * @var string
     */
    public $upperpattern = '/(.*?)([亿萬万仟佰拾元角分厘]*)/u';
    /**
     * 中文数字大写
     * @var array
     */
    public $upperWords = array(
        '零','壹','贰','叁','肆','伍','陆','柒','捌','玖'
        );
    ...
    */
     ...
     * @var string
     */
    public $lowerpattern = '/(.*?)([亿万千百十元角分厘]*)/u';
    /**
    * 中文数字小写
    * @var array
    */
    public $lowerWords = array(
        '零','一','二','三','四','五','六','七','八','九'
        );
    /**
    * 进位数
    ...
    */
     ...
     * 当前段基础进位
     */
    public $carryNumberBase = 0;
    /**
    * 字符串的预处理结果
    * @var array
    */
    public $prep_result = array();
    /**
     * 小数点位置
     * @var integer
     */
